...
This page contain the download link for our proposed data DeepFake Minist+.
...
![alt text](https://github.com/huangjiadidi/DeepFakeMinst/readme_src/main_result.png?raw=true)
